...
public class Composition {
	...
	public static void main(String[] args) throws ParseException {
		...
		SimpleDateFormat dataSimplificada = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss");
		
		Comment comentario1 = new Comment("Have a nice trip!");
		Comment comentario2 = new Comment("Wow that's awesome!");
		Post post1 = new Post(
				dataSimplificada.parse("21/06/2018 13:05:44"), 
		...
		Post post2 = new Post(
				dataSimplificada.parse("28/07/2018 23:14:19"), 
				"Good night guys", 
				"See you tomorrow", 
				5);
